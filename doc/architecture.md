...
Инструменты [БЭМа](http://ru.bem.info) позволяет абстрагироваться от условностей разметки и вёрстки и размечать страницу не напрямую, гипертекстом, но с помощью более _высокоуровневого языка_.
...
Контекстный блок следует применять там, где будет использоваться модификация абстрактного.
